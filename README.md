...
в подробности структуры левых подвыражений.

<команда> ::= <двухместная команда> | <трёхместная команда> | <формула>

<двухместная команда> ::= <формула> <дмоп> <команда>

<дмоп> ::= `;` | `:`

<трёхместная команда> ::= <формула> <тмоп с ;> <формула> `;` <команда> | <формула> <тмоп с ,> <формула> `,` <команда>
