...
`<блок>` `::+` <оп> `==>` <заготовка> <нс>

или

`<блок>` `::+` <оп> <образец> <оп> `==>` <заготовка> <нс>

или 

`<блок>` `::+` <оп> <образец> <бми> `==>` <заготовка> <нс>

где <бми> — любое метаимя с основой на `блок` (<имя элемента> ::= `блок`)
...
может содержать нумерованные или не нумерованные метаимена соответствующие категориям <имя>, 
<формула>, <команда> и <блок>. Все эти метаимена должны быть упомянуты в заготовке ровно один раз.
...
<блок> ::+ IF <формула> THEN <команда> <блок> ==> \
           (<формула> -> (<команда>); \
            <блок>) 

<блок> ::+ ELSEIF <формула> THEN <команда> <блок> ==> \
           (<формула> -> (<команда>); \
            <блок>) 

<блок> ::+ ELSE <команда> END ==> \
           (<команда>)

<блок> ::+ END ==> \
           ()

<блок> ::+ CASE <формула> <блок> ==> \
           (_ = <формула>; <блок>)

<блок> ::+ ON <формула> DO <команда> <блок> ==> \
           (_ == <формула> -> (<команда>); \
            <блок>)

<блок> ::+ WHILE <формула> DO <команда> END ==> \
           (loop (): \
            <формула> -> ((<команда>) ; loop()); \
            ()) 

<блок> ::+ FOR <имя> FROM <формула 1> UPTO <формула 2> DO <команда> END ==> \
           (end = <формула 2>; \
            loop (<имя> = <формула 1>): \
            <имя> >= end -> (); \
            (<команда>); \
...
<блок> ::+ FOR <имя> UPTO <формула 2> DO <команда> END ==> \
           (end = <формула 2>; \
            loop (<имя> = 0): \
            <имя> >= end -> (); \
            (<команда>); \
