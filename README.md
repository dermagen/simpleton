...
~~~ ПРОСТЕЦ
 ...
 <зф> ::+ ABS <зф> ==> ( _x = <зф>; _x < 0 -> - _x; _x )

~~~
> NB. Имена, начинающиеся с подчерка, автоматически переименовываются во время
> подстановки во избежании конфликта с пользовательскими именами
