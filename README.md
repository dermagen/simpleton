...
операции `X` _<зо>_ `Y ; Z` или `X` _<зо>_ `Y , Z` где <зо> это знак операции; два выражения 
...
<ф> — произвольная формула а _<в>_ — произвольная команда или формула предназначена 
